...
////// Lighting:
                ...
                float3 Set_BaseColor = lerp( node_482, (node_482*node_7651), _Is_LightColor_Base );
                ...
                float3 _Is_LightColor_1st_Shade_var = lerp( node_7531, (node_7531*node_7651), _Is_LightColor_1st_Shade );
                ...
                float3 Set_FinalBaseColor = lerp( lerp(node_4770,lerp(_Is_LightColor_1st_Shade_var,lerp( node_5308, (node_5308*node_7651), _Is_LightColor_2nd_Shade ),Set_ShadeShadowMask),Set_FinalShadowMask), node_4770, _Is_1st_ShadeColorOnly );
                ...
                float3 Set_FinalCompOut = (saturate(lerp( _RimLight_var, lerp( (_RimLight_var*node_3547), (_RimLight_var+node_3547), _Is_BlendAddToMatCap ), _MatCap ))+(DecodeLightProbe( normalDirection )*_GI_Intensity)); // Final Composition
