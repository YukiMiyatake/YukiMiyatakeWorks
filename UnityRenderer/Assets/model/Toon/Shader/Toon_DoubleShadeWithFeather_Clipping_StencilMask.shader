...
////// Lighting:
                ...
                float Set_FinalShadowSample = saturate((node_8323 + ( (lerp( node_4315, (node_4315*saturate(((attenuation*node_9089)+node_9089+_Tweak_SystemShadowsLevel))), _Set_SystemShadowsToBase ) - node_583) * ((1.0 - _Set_1st_ShadePosition_var.rgb).r - node_8323) ) / (_BaseColor_Step - node_583)));
                ...
                float node_5267 = 1.0;
                float node_8830 = 0.0;
                float3 Set_RimLight = (lerp( _RimLightColor.rgb, (_RimLightColor.rgb*Set_LightColor), _Is_LightColor_RimLight )*saturate(lerp( (node_8830 + ( (node_7879 - _RimLight_InsideMask) * (node_5267 - node_8830) ) / (node_5267 - _RimLight_InsideMask)), step(_RimLight_InsideMask,node_7879), _RimLight_FeatherOff )));
                float3 _RimLight_var = lerp( node_389, (node_389+Set_RimLight), _RimLight );
